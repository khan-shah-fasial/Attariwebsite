...
//--------------=============================== Blog  ================================------------------------------
    ...
    public function blog(Request $request){
        $blog = Blog::where('status', 1)->whereJsonContains('blog_category_ids', '3')->orderBy('updated_at', 'desc')->paginate(2);
...
// =================--------------------- NEW ---------------------=========================
    ...
    public function course_detail($slug){
        ...
        $faq = Faq::where('course_id', $cms->course_id)->where('status', 1)->orderBy('title_no', 'ASC')->get();
