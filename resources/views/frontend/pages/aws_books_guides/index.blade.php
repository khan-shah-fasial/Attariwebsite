            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="breadcrums_section paddtb80">
                        <h1 class="sm-aboutus">AWS Books Guides</h1>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item"><a>»</a></li>
                                <li class="breadcrumb-item"><a><b>AWS Books Guides</b></a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
    ...
    <section class="practice_test_section pt-5 pb-5">
        <div class="container">
            <div class="practice_test_box">
                <div class="row">
                    <div class="col-md-12">
                        <h5 class="download_head pb-4">AWS Study Material</h5>
                    </div>
