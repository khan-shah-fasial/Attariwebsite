            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="breadcrums_section paddtb80">
                        <h1 class="sm-aboutus">MCSE Practice Test</h1>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item"><a>»</a></li>
                                <li class="breadcrumb-item"><a><b>MCSE Practice Test</b></a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
    ...
    <section class="practice_test_section pt-5 pb-5">
        <div class="container">
            <div class="practice_test_box">
                <div class="row">
                    <div class="col-md-12">
                        <h5 class="download_head pb-4">MCSE Certification is retired by Microsoft, however you can opt for
                            Role Based Certification like Azure AZ-104</h5>
                    </div>

                    <div class="col-md-12">
                        <div class="pdf_boxex_practice">
                            <a href=""><img src="/assets/frontend/images/pdf.webp"> <span> AZURE -104- Part1<span></a>
                        ...
                        <div class="pdf_boxex_practice">
                            <a href=""><img src="/assets/frontend/images/pdf.webp"> <span> AZURE -104- Part2<span></a>
                            <div class="download_button">
                                <a hreef="#">Download PDF <i aria-hidden="true" class="fas fa-download"></i></a>
                            </div>
                        </div>
