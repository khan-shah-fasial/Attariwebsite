...
@section('page.content')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="breadcrums_section paddtb80">
                        <h1 class="sm-aboutus">AWS Practice Test</h1>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item"><a>»</a></li>
                                <li class="breadcrumb-item"><a><b>AWS Practice Test</b></a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
    ...
    <section class="practice_test_section pt-5 pb-5">
        <div class="container">
            <div class="practice_test_box">
                <div class="row">
                    <div class="col-md-12">
                        <h5 class="download_head pb-4">Download AWS Solution Architect PDF File</h5>
                    </div>

                    <div class="col-md-12">
                        <div class="pdf_boxex_practice">
                            <a href=""><img src="/assets/frontend/images/pdf.webp"> <span>AWS SAA-C03 Dumps<span></a>
    ...
    <section id="testimonials" class="testiminilas_sec gradiant_bg pt-5 pb-5">
        <div class="container">
            <h3 class="heading_title text-center pddtop_0 pb-3 textcolor_wht ">AWS Training Testimonials</h3>
    ...
    <section id="faqs" class="overview py-5">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h4 class="section_heading pb-3 text-center textcolor_blck"> FAQs on AWS Practice Test </h4>
