...
@section('page.content')
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="breadcrumb">
                        <h1 class="sm-aboutus">AZURE Books Guides</h1>
                        <p>
                            <span class="home_breadcrumb"><a href="index.php">Home</a></span> »
                            <span class="first_breadcrumb"><a href="learning.php">Learning</a></span> »
                            <span class="first_breadcrumb"><a>AZURE Books Guides</a></span>
                        </p>
                    </div>
                </div>
            </div>
    ...
    <section class="practice_test_section pt-5 pb-5">
        <div class="container">
            <div class="practice_test_box">
                <div class="row">
                    <div class="col-md-12">
                        <h5 class="download_head pb-4">Azure Study Material</h5>
                    </div>

                    <div class="col-md-12">
                        <div class="pdf_boxex_practice">
                            <a href=""><img src="/assets/frontend/images/pdf.webp"> <span> Microsoft Azure EBook<span></a>
    ...
    <section id="faqs" class="overview py-5">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h4 class="section_heading pb-3 text-center textcolor_blck"> FAQs on Azure Practice Test </h4>
